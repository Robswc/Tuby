...
openFolderButton = Button(root, borderwidth="0", bg="#C3C3C3", text="Open Folder", font="Helvetica 13 bold", command=(lambda: openFolder()))
openFolderButton.grid(row=5, column=0, pady=(10, 10), columnspan=2, sticky='ew')
